...
<section class="container mx-auto p-4 mt-4">
  <div class="rounded-lg shadow-md bg-white p-3">
    ...
    <?= loadPartial('message') ?>
    <!-- Loads the message partial, possibly for notifications or alerts -->
    ...
    <div class="flex justify-between items-center">
      ...
      <!-- If the current user is the owner of the listing, show the Edit and Delete buttons -->
      ...
      <div class="flex space-x-4 ml-4">
        ...
        <!-- Delete Form -->
        <form method="POST">
          <input type="hidden" name="_method" value="DELETE"> <!-- Hidden input to override method for DELETE -->
    ...
    <div class="p-4">
      ...
      <!-- Displays the title of the listing -->
      ...
      <ul class="my-4 bg-gray-100 p-4">
        ...
        <!-- Displays the formatted salary of the listing -->

        <li class="mb-2">
          <!-- Displays the city and state of the job listing -->
        ...
        <!-- Displays tags associated with the listing, if any -->
        <?php endif; ?>
...
<section class="container mx-auto p-4">
  ...
  <!-- Provides an email link for job applications -->
